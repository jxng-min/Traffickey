...
public class LoadingManager : MonoBehaviour
{
    ...
    [Header("로딩 UI의 툴팁을 출력할 TMP 라벨")]
    [SerializeField] private TMP_Text m_tip_label;

    [Header("로딩 UI 툴팁에 출력될 문구")]
    [SerializeField] [TextArea] string[] m_tool_tips;
    ...
    public void LoadScene(string scene_name)
    {
        ...
        m_tip_label.text = m_tool_tips[UnityEngine.Random.Range(0, m_tool_tips.Length - 1)];
